                        ...
                        <x-form action="{{ route('threads.store') }}">
                            <div class="space-y-8">
                                ...
                                <div>
                                    ...
                                    <select name="tags[]" id="tags" x-data="{}" x-init="setTimeout(function(){choices($el)}, 1);" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" multiple>
                                        @foreach ($tags as $tag)
