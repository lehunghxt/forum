<x-guest-layout>
    <main class="grid grid-cols-4 gap-8 mt-8 wrapper">
        ...
        <section class="flex flex-col col-span-12  gap-y-4 md:col-span-3">
                    ...
                    <div class="space-y-6">
                        <x-form action="{{ route('threads.update', $thread->slug()) }}">
                            <div class="space-y-8">
                                ...
                                {{-- Title --}}
                                <div>
                                    <x-form.label for="title" value="{{ __('Tiêu đề') }}" />
                                ...
                                <div>
                                    ...
                                    <select name="tags[]" id="tags" x-data="{}" x-init="setTimeout(function () { choices($el) }, 2)" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" multiple>
                                        @foreach ($tags as $tag)
                                ...
                                {{-- Body --}}
                                <div>
                                    <x-form.label for="body" value="{{ __('Nội dung') }}" />
