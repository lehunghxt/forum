<div>
    ...
    <div x-data="
    {
        ...
        <div x-show="!editReply" class="relative">
            ...
            <div class="p-2 space-y-4 text-gray-500 bg-white border-l-4 border-blue-300 shadow">
                <div class="grid grid-cols-8">
                    ...
                    <div class="relative col-span-6 space-y-4">
                        <p>
                           <b>{{ $author->name }}:</b> {{ $replyOrigBody }}
                        </p>

                        <div class="flex justify-between w-full bottom-1 mt-2">
                            ...
                            <div class="flex items-center text-xs text-gray-500">
                                ...
                                Trả lời: {{ $createdAt->diffForHumans() }}
                            </div>
                        </div>
                    </div>
                </div>
